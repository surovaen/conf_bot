    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='products.course', verbose_name='Курс')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers', models.JSONField(blank=True, null=True, verbose_name='Ответы на вопросы предзаписи')),
                ('is_paid', models.BooleanField(default=False, verbose_name='Оплачено')),
                ('conference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='products.conference', verbose_name='Конференция')),

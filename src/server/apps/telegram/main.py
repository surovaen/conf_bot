...
CALLBACK_HANDLERS_MAP = {
    none_callback: {
        'func': lambda callback: callback.data == Callback.NONE.value,
    },
    conference_callback: {
    ...
    conference_ticket_callback: {
        'func': lambda callback: callback.data.startswith(Callback.CONFERENCE_TICKET.value),
    },
    conference_payment_callback: {
